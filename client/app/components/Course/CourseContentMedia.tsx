                                    ...
                                    <div className="w-full my-5 dark:text-white text-black">
                                        ...
                                        </div>
                                        {
                                            user.role === "admin" && item.commentReplies.length === 0 && (
                                                <span className={`${styles.label} !ml-12 cursor-pointer`}
                                                    onClick={() => {
                                                    ...
                                                    <div className="pl-2">
                                                        <div className="flex items-center">
                                                            <h5 className="text-[20px]">
                                                                {i.user.name}
                                                            </h5> {i.user.role === "admin" && <VscVerifiedFilled className="text-[#0095F6] ml-2 text-[20px]" />}
                                                        </div>
                                                        <p>{i.comment}</p>
                                ...
                                <div className="w-full flex 800px:ml-16 my-5 text-black dark:text-white">
                                    ...
                                    <div className="pl-3">
                                        <div className="flex items-center">
                                            <h5 className="text-[20px]">
                                                {item.user.name}
                                            </h5> {item.user.role === "admin" && <VscVerifiedFilled className="text-[#0095F6] ml-2 text-[20px]" />}
                                        </div>
                                        <p>{item.answer}</p>
                                        <small className="text-[#ffffff83]">
                                            {format(item?.createdAt)} •
                            ...
                            <>
                                <div className="w-full flex relative dark:text-white text-black">
                                    <input
                                        ...
                                        className={`block 800px:ml-12 mt-2 outline-none bg-transparent border-b border-[#00000027] dark:border-[#fff] p-[5px] w-[95%] dark:text-white text-black ${answer === "" || answerCreationLoading && 'cursor-not-allowed'}`}
                                    />
                                    <button
                                        type="submit"
                                        className="absolute right-0 bottom-1"
